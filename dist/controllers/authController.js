...
exports.getApiKey = exports.generateApiKey = exports.getLoggedInUser = exports.updateProfile = exports.getProfile = exports.resetPassword = exports.forgotPassword = exports.verifyEmail = exports.login = exports.signup = void 0;
...
exports.verifyEmail = (0, asyncHandler_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        return next(new AppError_1.AppError('Code validation fail', 500));
...
exports.generateApiKey = (0, asyncHandler_1.asyncHandler)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.user;
    const user = yield userModel_1.User.findById(_id);
...
exports.getApiKey = (0, asyncHandler_1.asyncHandler)((req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.user;
    const user = yield userModel_1.User.findById(_id);
