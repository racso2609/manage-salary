...
router.get('/create-api-key', authenticate_1.protect, authController_1.generateApiKey);
router.get('/get-api-key', authenticate_1.protect, authController_1.getApiKey);
