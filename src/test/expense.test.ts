...
describe('Expenses', () => {
    ...
    test('create expenses from json', async ({ token }) => {
        const jsonFromBinanceCSV = [
            {
                orderNumber: '20488139325962092544',
                advNo: '11317924692102754304',
                tradeType: 'SELL',
                asset: 'USDT',
                fiat: 'VES',
                fiatSymbol: 'Bs',
                amount: '20.00000000',
                totalPrice: '510.60000000',
                unitPrice: '25.53',
                orderStatus: 'COMPLETED',
                createTime: 1683375488000,
                commission: '0.01',
                counterPartNickName: 'Col***',
            ...
            {
                orderNumber: '20488139325962092542',
                advNo: '11317924692102754304',
                tradeType: 'SELL',
                asset: 'USDT',
                fiat: 'VES',
